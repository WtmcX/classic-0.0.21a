...
import com.demez.lwjgl.FontAllowedCharacters;
import com.demez.lwjgl.PNGLoader;
...
public final class Font {
	...
	public Font(String var1, Textures textures) {
		charWidths = new int[256];
		fontTextureName = null;
		MinecraftImageData bufferedimage = PNGLoader.loadPNG(PNGLoader.loadResourceBytes(var1));
		...
		for (int i1 = 0; i1 < 256; i1++) {
			...
			float f1 = 0.0F;
			float f2 = 0.0F;
			tessellator.vertexUV(0.0F, 0.0F + f, 0.0F, (float) l1 / 128F + f1, ((float) k2 + f) / 128F + f2);
			tessellator.vertexUV(0.0F + f, 0.0F + f, 0.0F, ((float) l1 + f) / 128F + f1, ((float) k2 + f) / 128F + f2);
			tessellator.vertexUV(0.0F + f, 0.0F, 0.0F, ((float) l1 + f) / 128F + f1, (float) k2 / 128F + f2);
			tessellator.vertexUV(0.0F, 0.0F, 0.0F, (float) l1 / 128F + f1, (float) k2 / 128F + f2);
			tessellator.end();
			GL11.glEndList();
		}
